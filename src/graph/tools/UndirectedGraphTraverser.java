...
public class UndirectedGraphTraverser {
	...
	private UndirectedGraphTraverser() {}
	
	public static List<Vertex> depthFirstRepresentation(GraphIF graphToTraverse, Vertex initialVertex) {
	...
	public static List<Vertex> breadthFirstRepresentation(GraphIF graphToTraverse, Vertex initialVertex) {
		List<Vertex> visitedVertices = new ArrayList<Vertex>();
